...
func (tq *TodoQuery) FirstID(ctx context.Context) (id qid.ID, err error) {
	var ids []qid.ID
...
func (tq *TodoQuery) FirstIDX(ctx context.Context) qid.ID {
...
func (tq *TodoQuery) OnlyID(ctx context.Context) (id qid.ID, err error) {
	var ids []qid.ID
...
func (tq *TodoQuery) OnlyIDX(ctx context.Context) qid.ID {
...
func (tq *TodoQuery) IDs(ctx context.Context) ([]qid.ID, error) {
	var ids []qid.ID
...
func (tq *TodoQuery) IDsX(ctx context.Context) []qid.ID {
	ids, err := tq.IDs(ctx)
	if err != nil {
		panic(err)
	}
