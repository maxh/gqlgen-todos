...
func (ou *OrganizationUpdate) SetTenantID(id qid.ID) *OrganizationUpdate {
...
func (ou *OrganizationUpdate) AddUserIDs(ids ...qid.ID) *OrganizationUpdate {
...
func (ou *OrganizationUpdate) RemoveUserIDs(ids ...qid.ID) *OrganizationUpdate {
...
// SetTenantID sets the "tenant" edge to the Tenant entity by ID.
func (ouo *OrganizationUpdateOne) SetTenantID(id qid.ID) *OrganizationUpdateOne {
...
// AddUserIDs adds the "users" edge to the User entity by IDs.
func (ouo *OrganizationUpdateOne) AddUserIDs(ids ...qid.ID) *OrganizationUpdateOne {
...
// RemoveUserIDs removes the "users" edge to User entities by IDs.
func (ouo *OrganizationUpdateOne) RemoveUserIDs(ids ...qid.ID) *OrganizationUpdateOne {
