...
func (uq *UserQuery) FirstID(ctx context.Context) (id qid.ID, err error) {
	var ids []qid.ID
...
func (uq *UserQuery) FirstIDX(ctx context.Context) qid.ID {
...
func (uq *UserQuery) OnlyID(ctx context.Context) (id qid.ID, err error) {
	var ids []qid.ID
...
func (uq *UserQuery) OnlyIDX(ctx context.Context) qid.ID {
...
func (uq *UserQuery) IDs(ctx context.Context) ([]qid.ID, error) {
	var ids []qid.ID
...
func (uq *UserQuery) IDsX(ctx context.Context) []qid.ID {
	ids, err := uq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (uq *UserQuery) sqlAll(ctx context.Context) ([]*User, error) {
	...
	if query := uq.withOrganization; query != nil {
		...
		for _, n := range neighbors {
			nodes, ok := nodeids[n.ID]
			if !ok {
				return nil, fmt.Errorf(`unexpected foreign-key "organization_users" returned %v`, n.ID)
			}
			for i := range nodes {
